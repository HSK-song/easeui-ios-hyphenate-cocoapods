...
- (void)viewDidLoad
{
    ...
    [backButton setImage:[[UIImage imageNamed:@"EaseUIResource.bundle/back"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
